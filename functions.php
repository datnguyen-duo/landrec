...
function site_scripts() {
    wp_enqueue_style('site-style', get_theme_file_uri('/build/style-index.css'), array(), '2.4', false);
    wp_enqueue_script('main-js-file', get_theme_file_uri('/build/index.js'), array(), '2.4', true);
